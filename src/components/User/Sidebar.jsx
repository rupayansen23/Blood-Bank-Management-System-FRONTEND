...
import { Syringe, SquareUserRound, Menu, X } from 'lucide-react';
            ...
            <div className="">
                ...
                <div className={`${isOpen ? 'm-8' : 'm-4'} font-bold`}>
                    <ul className="">
                        <div className="mb-4">
                            <Link to="userInfo">
                                <li className="flex cursor-pointer items-center gap-3 bg-pink-200 hover:bg-pink-300 px-4 py-2 rounded-lg shadow-md hover:shadow-lg transition text-center justify-center" title="Your Information">
                                     <SquareUserRound className="w-5 h-5 text-gray-700" /> {isOpen && <span>Your Information</span>}
                                </li>
                            </Link>
                        </div>
                         <div className="mb-4">
                            <Link to="donations">
                                <li className="flex cursor-pointer items-center gap-3 bg-pink-200 hover:bg-pink-300 px-4 py-2 rounded-lg shadow-md hover:shadow-lg transition text-center justify-center" title="Your Donations">
                                    <Syringe className="w-5 h-5 text-gray-700" /> {isOpen && <span>Your Donations</span>}
                                </li>
                            </Link>
                         </div>
