      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="card w-96 shadow-xl bg-white">
          <div className="card-body bg-white text-black rounded-2xl">
            <h2 className="card-title justify-center text-3xl">User Login</h2>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="form-control mt-4">
                ...
                <input
                  ...
                  className={`input input-bordered bg-white border-gray-500 focus:outline-none focus:ring-2 focus:ring-pink-300 ${
